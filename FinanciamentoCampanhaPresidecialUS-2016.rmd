...
```{r}
#Criei uma estrtura base do gráfico para, na sequencia, adicionar os layers especificos de cada gráfico
g <- ggplot(aes(x = contb_receipt_dt_month, y = contb_receipt_amt), 
       data = USACampaign)+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  scale_x_date(date_breaks = "2 months", 
...
ggplot(aes(y=contb_receipt_amt, fill=cand_nm, x=""), data=USACampaign[USACampaign$contb_receipt_amt > 5400,])+
